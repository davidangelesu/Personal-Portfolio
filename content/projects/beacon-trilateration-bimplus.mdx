...
export const meta={
    ...
    githubRepository: 'https://github.com/davidangelesu/Tracking-App-REST-API-Server',
...
We needed to extended the functionality of their viewer, which utilizes Three.js, to be able to render the tracked entity inside the building model.
...
A companion Android App was also develop to Post to the backend  the distances obtained from the beacons to the device.
